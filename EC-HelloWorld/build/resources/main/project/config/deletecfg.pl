...
my $PLUGIN_NAME = "EC-HelloWorld";
my $projName    = "EC-HelloWorld-1.0.0.0";
...
my $xpath = $ec->getProperty("/myProject/helloworld_cfgs/$opts->{config}");
...
$ec->deleteProperty("/myProject/helloworld_cfgs/$opts->{config}");
